...
const Order = () => {
    ...
    const summaryCounts = {
        ...
        complete: filteredBoxes.filter(box => box.status_matching === "10").length,
        running: filteredBoxes.filter(box => box.status_matching === "5").length,
        pending: filteredBoxes.filter(box => box.status_matching === "1").length,
    };
